...
export const feedApi = {
  ...
  reactComment:   (postId: string, commentId: string, type: string) => api.post(`/posts/${postId}/comments/${commentId}/react`, { type }),
  unreactComment: (postId: string, commentId: string)               => api.delete(`/posts/${postId}/comments/${commentId}/react`),
