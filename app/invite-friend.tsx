...
const s = StyleSheet.create({
  ...
  heading:        { fontSize: 25, fontWeight: '700', textAlign: 'center', marginBottom: 8 },
  subheading:     { fontSize: 16, textAlign: 'center', lineHeight: 20, marginBottom: 28 },
  label:          { fontSize: 16, fontWeight: '500', marginBottom: 8 },
  input:          { borderWidth: 1, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, fontSize: 17, marginBottom: 14 },
  ...
  sentTitle:      { fontSize: 15, fontWeight: '600', marginBottom: 4 },
  sentRow:        { flexDirection: 'row', alignItems: 'center', gap: 8 },
  sentEmail:      { fontSize: 15 },
