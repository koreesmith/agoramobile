...
const s = StyleSheet.create({
  ...
  label: { fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.4, marginTop: 12, marginBottom: 6 },
  ...
  privacySubtitle: { fontSize: 12, marginTop: 2 },
  ...
  addMemberText: { fontWeight: '600', fontSize: 14 },
  ...
  inviteToken: { fontSize: 13, fontFamily: 'monospace' },
