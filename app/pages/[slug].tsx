...
const s = StyleSheet.create({
  ...
  displayName:    { fontSize: 18, fontWeight: '700', flexShrink: 1 },
  ...
  subBtnText:     { fontSize: 13, fontWeight: '700' },
  tabBar:         { flexDirection: 'row', borderBottomWidth: StyleSheet.hairlineWidth },
  tab:            { flex: 1, alignItems: 'center', paddingVertical: 12 },
  tabText:        { fontSize: 13, fontWeight: '600' },
  aboutLabel:     { fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.4, marginBottom: 2 },
  ...
  analyticsBtnText:{ fontSize: 13, fontWeight: '600' },
